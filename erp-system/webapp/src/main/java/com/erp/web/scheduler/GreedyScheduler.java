...
public class GreedyScheduler {
    ...
    public List<TimetableEntryRecord> generate(
        ...
        for (SectionRecord section : sections) {
            for (SubjectRecord subject : subjects) {
                ...
                while (remaining > 0) {
                    TimetableEntryRecord assigned = assignOneHour(
                            departmentId, section.id, semester, subject, faculties, rooms, slots,
    ...
    private TimetableEntryRecord assignOneHour(
            int departmentId,
            int sectionId,
            String semester,
            ...
            List<ClassroomRecord> rooms,
            List<TimeSlotRecord> slots,
            List<TimetableEntryRecord> currentEntries,
